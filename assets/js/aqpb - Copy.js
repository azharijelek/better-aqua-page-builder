...
jQuery(document).ready(function($){
	...
	$( "ul.blocks" ).bind( "sortstop", function(event, ui) {
		...
		if (ui.item.hasClass('ui-draggable')) {
			...
			// re-Init tinyMCE when block DROPped 
			//(lol) finally - Azhari
			if(ui.item.hasClass('block-aq_richtext_block')){
				...
				tinymce.init({
					...
					toolbar1: "undo redo bold italic underline strikethrough bullist numlist blockquote alignleft aligncenter alignright alignjustify bullist numlist link unlink fullscreen preview",
					toolbar2: "styleselect cut copy paste searchreplace forecolor backcolor anchor image media code inserttime charmap hr table ltr rtl removeformat",
				...
				// it works (yay!) But the menu can't be editable.
